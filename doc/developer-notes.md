...
- [Development guidelines](#development-guidelines)
    - [General Bitcoin Global](#general-bitcoin-global)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
Bitcoin Global uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
Bitcoin Global is a multi-threaded application, and deadlocks or other
...
([`valgrind.supp`](https://github.com/bitcoin-global/bitcoin-global/blob/master/contrib/valgrind.supp))
...
Bitcoin Global can be compiled with various "sanitizers" enabled, which add
...
However, in open source software such as Bitcoin Global, where everyone uses
...
pay attention to for reviewers of Bitcoin Global code.

General Bitcoin Global
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers.
  ...
  - *Rationale*: Bitcoin Global uses tinyformat, which is type safe. Leave them out to avoid confusion.
...
Some of these are maintained by active developers of Bitcoin Global, in which case changes should probably go
directly upstream without being PRed directly against the project. They will be merged back in the next
subtree merge.

Others are external projects without a tight relationship with our project. Changes to these should also
be sent upstream, but bugfixes may also be prudent to PR against Bitcoin Global so that they can be integrated
...
- Wallet RPCs call BlockUntilSyncedToCurrentChain to maintain consistency with
  ...
  - *Rationale*: In previous versions of Bitcoin Global, the wallet was always
