# Support for Output Descriptors in Bitcoin Global

Since Bitcoin Global v0.17, there is support for Output Descriptors. This is a
...
existing Bitcoin Global wallets, a convenience function `combo` is
...
All RPCs in Bitcoin Global will include the checksum in their output. Only
