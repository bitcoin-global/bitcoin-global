...
static const char* qt_argv = "bitglob-qt";
...
void BitcoinApplication::initializeResult(bool success)
{
    ...
    if(success)
    {
        ...
        // bitglobal: URIs or payment requests:
        if (paymentServer) {
...
int GuiMain(int argc, char* argv[])
{
    ...
    /// 6. Determine availability of data directory and parse bitglob.conf
    ...
    // bitglobal: links repeatedly have their payment requests routed to this process:
    if (WalletModel::isWalletEnabled()) {
