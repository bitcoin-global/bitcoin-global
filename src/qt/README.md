...
Used to process BIP21 and BIP70 (see https://github.com/bitcoin/bitcoin/pull/11622) payment URI / requests. Also handles URI based application switching (e.g. when following a bitglobal:... link from a browser).
...
* `bitcoinunits.(h/cpp)`: BG / mBG / etc handling
* `callback.h`
