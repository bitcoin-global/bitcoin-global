...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bitcoin Global address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitglobal: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bitcoin Global addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bitcoin Global addresses"));
    ...
    openAction->setStatusTip(tr("Open a bitglobal: URI or payment request"));
