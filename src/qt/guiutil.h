...
#ifndef BITGLOB_QT_GUIUTIL_H
#define BITGLOB_QT_GUIUTIL_H
...
namespace GUIUtil
{
    ...
    // Parse "bitglobal:" URI into recipient object, return true on successful parsing
