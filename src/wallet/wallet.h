...
#ifndef BITGLOB_WALLET_WALLET_H
#define BITGLOB_WALLET_WALLET_H
 ...
 * change.
 *
 * The Bitcoin Global wallet was originally a collection of unrelated private
