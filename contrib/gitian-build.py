...
def setup():
    ...
    if not os.path.isdir('bitcoin'):
        subprocess.check_call(['git', 'clone', 'https://github.com/bitcoin-global/bitcoin-global-playground.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/bitcoin-global/bitcoin-global-playground', help='Specify the URL of the repository. Default is %(default)s')
