# Bootstrappable Bitcoin Global Builds
...
- 24GB of free disk space on the partition that the Bitcoin Global git repository
  resides in
...
For a Bitcoin Global depends development environment, simply invoke
...
From the top of a clean Bitcoin Global repository:
...
To use dongcarl's substitute server for Bitcoin Global builds after having
