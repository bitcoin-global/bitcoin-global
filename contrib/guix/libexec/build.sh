...
# Setup the directory where our Bitcoin Global build for HOST will occur
...
(
    ...
    # Setup the directory where our Bitcoin Global build for HOST will be
    # installed. This directory will also later serve as the input for our
    # binary tarballs.
    INSTALLPATH="${PWD}/installed/${DISTNAME}"
    mkdir -p "${INSTALLPATH}"
    # Install built Bitcoin Global to $INSTALLPATH
