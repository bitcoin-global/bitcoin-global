...
Verify that a glbitcoind node can load multiple wallet files
"""
import os
import shutil
import time
...
class MultiWalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.stop_node(
            i=0,
            expected_stderr='Error: Error loading {}: Wallet requires newer version of Bitcoin Global'.format(
