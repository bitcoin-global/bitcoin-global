...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BG from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 BG with subtract fee from amount
        ...
        # Sendmany 10 BG with subtract fee from amount
        ...
        # This will raise an exception for attempting to get the private key of an invalid Bitcoin Global address
        assert_raises_rpc_error(-5, "Invalid Bitcoin Global address", self.nodes[0].dumpprivkey, "invalid")

        # This will raise an exception for attempting to set a label for an invalid Bitcoin Global address
        assert_raises_rpc_error(-5, "Invalid Bitcoin Global address", self.nodes[0].setlabel, "invalid address", "label")

        # This will raise an exception for importing an invalid address
        assert_raises_rpc_error(-5, "Invalid Bitcoin Global address or script", self.nodes[0].importaddress, "invalid")
