...
# Objects that map to glbitcoind objects, which can be serialized/deserialized
...
class CTransaction:
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in glbitcoind
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in glbitcoind indicates these should be deserialized as blocks
