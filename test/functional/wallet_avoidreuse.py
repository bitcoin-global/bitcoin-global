...
class AvoidReuseTest(BitcoinTestFramework):
    ...
    def test_fund_send_fund_senddirty(self):
        '''
        Test the same as test_fund_send_fund_send, except send the 10 BG with
        the avoid_reuse flag set to false. This means the 10 BG send should succeed,
    ...
    def test_fund_send_fund_send(self, second_addr_type):
        ...
        [0] sends 10 BG to A.
        [1] spends 5 BG from A. (leaving roughly 5 BG useable)
        [0] sends 10 BG to A again.
        [1] tries to spend 10 BG (fails; dirty).
        [1] tries to spend 4 BG (succeeds; change address sufficient)
        '''
